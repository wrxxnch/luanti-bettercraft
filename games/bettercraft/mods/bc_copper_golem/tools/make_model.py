#!/usr/bin/env python3
"""Generate models/bc_copper_golem.b3d -- the copper golem mesh + walk animation.
...
Run:  python3 make_model.py   (writes ../models/bc_copper_golem.b3d)
"""
import math
import os
import struct
...
texs = chunk(b"TEXS", cstr("bc_copper_golem.png") + i(0, 0) + f(0,0, 1,1, 0))
...
dest = os.path.join(os.path.dirname(__file__), "..", "models", "bc_copper_golem.b3d")
