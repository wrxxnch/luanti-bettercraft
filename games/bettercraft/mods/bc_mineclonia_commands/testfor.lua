...
minetest.register_chatcommand("testfor", {
    ...
    func = function(name, param)
        ...
        return success, success and ("Found " .. count) or "Not found"
...
minetest.register_chatcommand("testforblock", {
    ...
    func = function(name, param)
        ...
        return success, success and "Block correct" or "Block different"
...
minetest.register_chatcommand("testforblocks", {
    ...
    description = "Compara duas áreas de blocks. Sintaxe: <area1> <area2> <destiny>. Suporta execute=<command> e/ou execute!=<command>. ex:testforblocks ~ ~1 ~ ~ ~1 ~ xyz execute=setblock xyz mcl_redstone_torch:redstoneblock,execute!=setblock xyz mcl_core:dirt",
    ...
    func = function(name, param)
        ...
        return success, success and "Áreas iguais" or "Áreas differents"
...
--------------------------------------------------
minetest.log("action", "[Mineclonia] testfor loaded")
--------------------------------------------------
